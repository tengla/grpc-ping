...
type PingServiceClient interface {
	Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (PingService_PingClient, error)
}
...
func (c *pingServiceClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (PingService_PingClient, error) {
	stream, err := c.cc.NewStream(ctx, &PingService_ServiceDesc.Streams[0], "/PingService/Ping", opts...)
	if err != nil {
		return nil, err
	}
...
type PingServiceServer interface {
	Ping(*Empty, PingService_PingServer) error
...
func (UnimplementedPingServiceServer) Ping(*Empty, PingService_PingServer) error {
